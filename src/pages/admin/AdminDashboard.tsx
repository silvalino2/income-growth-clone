...
const AdminDashboard = () => {
  ...
  // Prevent flicker before auth is ready
  ...
  const statsData = [
    ...
    },
    {
      ...
      value: `$${stats.activeDeposits.toLocaleString()}`,
      icon: ArrowUpCircle,
      color: "text-info",
    },
    {
          ...
          {statsData.map((stat) => (
            <div key={stat.label} className="dashboard-card">
              <div className="flex items-center justify-between mb-4">
                <div
                  className={`w-12 h-12 rounded-lg bg-secondary flex items-center justify-center ${stat.color}`}
                >
